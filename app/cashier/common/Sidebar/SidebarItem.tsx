...
import PatientSearchForm from "@/app/operational/front-desk/patient-registration/existing-patient/patient-search-form";
import CashierPatientSearch from "../cashier-patient-search";
