...
const PatientToExamineListTable = ({ visits, totalPages, handlePageChange, setActiveMRID, setActiveVisit }: PatientToExamineListTableProps) => {
                  ...
                  <ul className="flex items-center gap-2 2xsm:gap-4">
                    <motion.li className="relative" whileHover={{ scale: 1.2, transition: { duration: 0.2 }}} whileTap={{ scale:0.9 }} >  
                        <Link
                            ...
                            onClick={() => { setActiveVisit(visit); setActiveMRID(visit.medical_record.id) } }
