...
const MedicalRecordDeleteConfirmation = ({ handleClose, handleDelete }: DeleteConfirmationProps) => {
    return (
        <div className="w-full max-w-142.5 rounded-lg bg-white py-12 px-8 text-center dark:bg-boxdark md:py-15 md:px-17.5">
            ...
            <h3 className="mt-5.5 pb-2 text-xl font-bold text-black dark:text-white sm:text-2xl">Are you sure you want to delete this medical record's data?</h3>
            <p className="mb-10">This medical record data and anything related to it will be deleted.</p>
