            ...
            <div className="flex flex-col gap-10">
                <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                    ...
                    <div className="p-4 sm:p-6 xl:p-9">
                        ...
                        <div className="mt-6 mb-6 grid grid-cols-1 border border-stroke dark:border-strokedark xsm:grid-cols-2 sm:grid-cols-4">
                        ...
                        <div className="border border-stroke dark:border-strokedark">
                            ...
                            <div className="min-w-[670px]">
                                <div className="grid grid-cols-12 border-b border-stroke py-3 px-5 dark:border-strokedark">
